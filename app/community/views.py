...
@extend_schema(
    ...
    parameters=[
        OpenApiParameter(name='rate', description='Rating value', required=True, type=int)
    ]
)
...
@extend_schema(
    ...
    parameters=[
        OpenApiParameter(name='cardset_id', description='Cardset ID to copy', required=True, type=int)
    ]
)
@api_view(['POST'])
