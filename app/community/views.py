...
@swagger_auto_schema(
    method='post',
    request_body=RateCreateSerializer,
...
@swagger_auto_schema(
    method='post',
    request_body=CopyCardsetRequestSerializer,
...
def cardset_save(request):
    try:
        with transaction.atomic():
            serializer = CopyCardsetRequestSerializer(data=request.data)
            if serializer.is_valid():
                cardset_id = serializer.validated_data['cardset_id']
